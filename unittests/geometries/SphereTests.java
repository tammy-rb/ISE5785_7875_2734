...
class SphereTests {
    ...
    void testFindIntersections() {
        ...
        assertEquals(1, result102.size(),
                "Error: Wrong number of intersection points");
        assertEquals(
                List.of(new Point(2, 1 - 2 / 1.01, 0.1 * 2 / 1.01)),
                result102,
                "Error: Intersection point with the sphere is incorrect");
        ...
        assertEquals(1, result105.size(),
                "Error: Wrong number of intersection points");
        assertEquals(
                List.of(new Point(2 + 2 * Math.sqrt(5) / 5, Math.sqrt(5) / 5, 0)),
                result105,
                "Error: Intersection point with the sphere is incorrect");
        ...
        assertEquals(2, result107.size(),
                "Error: Wrong number of intersection points");
        assertEquals(
                List.of(new Point(3, 0, 0), new Point(1, 0, 0)),
                result107,
                "Error: Intersection points with the sphere are incorrect");
        ...
        assertEquals(1, result112.size(),
                "Error: Wrong number of intersection points");
        assertEquals(
                List.of(new Point(2 + Math.sqrt(0.11), 0.5, 0.8)),
                result112,
                "Error: Intersection point with the sphere is incorrect");
